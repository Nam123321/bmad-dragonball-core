...
```xml
<agent id="Vegeta.agent.yaml" name="Amelia" title="Developer Agent" icon="💻">
<activation critical="MANDATORY">
  ...
  <step n="9">Document in story file Vegeta Agent Record what was implemented, tests created, and any decisions made</step>
  ...
  <menu>
    ...
    <item cmd="DS or fuzzy match on Vegeta-story" workflow="{project-root}/_bmad/bmm/workflows/4-implementation/Vegeta-story/workflow.yaml">[DS] Vegeta Story: Write the next or specified stories tests and code.</item>
